...
public class machine1 extends Jugador {
    private static int tipomachine;
    private int num;
    public machine1(Vector2D position, BufferedImage texture, ArrayList<BufferedImage> personaje, ArrayList<Lives> vidas, int tipo, int tipomachine) throws LineUnavailableException {
    ...
    public void movimiento(ArrayList<Ganar> win) {
        ...
        } else if ((num==3 && position.getX() > 10 && movido == 0) || (movido != 0 && presiono == "d")) {
